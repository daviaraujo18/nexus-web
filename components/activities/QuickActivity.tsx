...
import { FaCheck, FaCamera, FaTrash } from 'react-icons/fa';
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-gray-700 placeholder:text-gray-400"
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-400">• tire uma foto como comprovação</span>
          </div>
          ...
          {photoPreview ? (
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-indigo-400 hover:bg-indigo-50 transition-colors">
              <input
                type="file"
                ref={fileInputRef}
              ...
              <div className="flex flex-col items-center justify-center gap-3">
                <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center">
                  <FaCamera className="w-6 h-6 text-indigo-600" />
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    (opcional) tire um print ou foto da atividade
                  </p>
                </div>
      ...
      {!readOnly && progress.status === 'in_progress' && (
        <div className="flex gap-3 pt-4">
          <button
            ...
            disabled={isLoading}
            className="flex-1 bg-green-600 text-white py-3 rounded-xl hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium transition-colors"
          >
